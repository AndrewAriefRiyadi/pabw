        ...
        <div class="box">
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="input">
                    ...
                    <input type="text" id="username" class="block mt-1 w-full" type="text" name="username":value="old('username')" required="" autofocus="" autocomplete="username">
                    @error('username') <span class="text-danger mt-3">{{ $message }}</span> @enderror
                </div>

                <div class="input">
                    <label for="phone">No HP</label>
                    <input type="number" id="phone" class="block mt-1 w-full" type="text" name="no_hp":value="old('no_hp')" required="" autofocus="" autocomplete="no_hp">
                    @error('no_hp') <span class="text-danger mt-3">{{ $message }}</span> @enderror
                </div>

                <div class="input">
                    <label for="alamat">Alamat</label>
                    <input type="text" id="alamat" class="block mt-1 w-full" type="text" name="alamat":value="old('alamat')" required="" autofocus="" autocomplete="alamat">
                    @error('alamat') <span class="text-danger mt-3">{{ $message }}</span> @enderror
                </div>
