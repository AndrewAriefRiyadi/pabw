                                        ...
                                        <div class="details-image-vertical black-slide rounded">
                                            <div>
                                                <img src="{{ asset('storage/' . $produk->foto) }}"
                                                    class="img-fluid blur-up lazyload" alt="{{ $produk->nama }}">
                                            </div>
                                            @if ($produk->images)
                                                @php
                            ...
                            <div class="col-md-6">
                                <div class="cloth-details-size">
                                    ...
                                    <div class="product-buttons">
                                        ...
                                        <a href="javascript:void(0)"
                                            onclick="event.preventDefault();document.getElementById('formKeranjang').submit();"
                                    ...
                                    <div class="mt-2 mt-md-3 border-product">
                                        <h6 class="product-title hurry-title d-block">Hurry Up! Left
                                            <span>{{ $produk->stok }}</span> in
                                            @if ($produk->status_stok == 1)
                                                Instock
                                            @else
                                                Out of Stock
                                            @endif
