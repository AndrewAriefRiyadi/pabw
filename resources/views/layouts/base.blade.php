...
<head>
    ...
    <meta name="apple-mobile-web-app-title" content="MyThrift">
    <meta name="msapplication-TileImage" content="{{ asset('assets/images/favicon.ico') }}">
    <meta name="msapplication-TileColor" content="#FFFFFF">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="description" content="MyThrift">
    <meta name="keywords" content="MyThrift">
                ...
                <div class="row gy-4">
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="footer-contact">
                            <div class="brand-logo">
                                <a href="{{ route('dashboard') }}" class="footer-logo float-start">
                                    LOGO
                                </a>
                            </div>
        ...
        <div class="sub-footer">
            <div class="container">
                <div class="row gy-3">
                    ...
                    <div class="col-md-6">
                        <p class="mb-0 font-dark">© 2023, MyThrift.</p>
                    </div>
                </div>
            </div>
        </div>
